...
resource "aws_apigatewayv2_integration" "lambda_integration" {
  ...
  integration_uri    = var.lambda_integration_route_premission.lambda_invoke_arn
...
resource "aws_lambda_permission" "apigateway_permission" {
  ...
  function_name = var.lambda_integration_route_premission.lambda_func_name
...
resource "aws_apigatewayv2_authorizer" "lambda_authorizer" {
  ...
  authorizer_uri                    = var.lambda_integration_route_premission.authorizer_uri
